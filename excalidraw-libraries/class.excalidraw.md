...
```json
{
	...
	"elements": [
		{
			"type": "ellipse",
			"version": 560,
			"versionNonce": 1808741887,
			"isDeleted": false,
			"id": "kUpMnmiDXR6g6UEAT0gEP",
			"fillStyle": "solid",
			"strokeWidth": 4,
			"strokeStyle": "solid",
			"roughness": 1,
			"opacity": 100,
			"angle": 3.2462209853036175,
			"x": -254.29955709884393,
			"y": -229.8540503829037,
			"strokeColor": "#1971c2",
			"backgroundColor": "#30385f",
			"width": 42.58354629410366,
			"height": 42,
			"seed": 1808037599,
			"groupIds": [
				"gQ2jWbzck8kAPS277LrmV"
			],
			"frameId": null,
			"roundness": {
				"type": 2
	...
	"appState": {
		...
		"currentItemBackgroundColor": "#30385f",
